...
% CSparse source files to compile (only a reduced set!)
cs = {'cs_dfs', 'cs_malloc', 'cs_spsolve', 'cs_lsolve', 'cs_ltsolve', ...
     'cs_util', 'cs_reach'} ;
...
srcdir = ['Source',filesep] ;
hfile = [pwd,filesep,'Include',filesep,'cs.h'];
